...
class SubscribePostTest(TestCase):
    ...
    def test_subscription_email_body(self):
        ...
        self.assertIn('Fabio Jacob', email.body)
        self.assertIn('27790490818', email.body)
        self.assertIn('fabio.oj@gmail.com', email.body)
        self.assertIn('11-99116-5900', email.body)
